    ...
    public class Example_ObjectData : MonoBehaviour
    {
        ...
        void OnGUI() {
            if (GUILayout.Button("保存json数据")) {
                ...
                userInfo.userBaseInfo.firstName = "Liming";
                userInfo.userBaseInfo.email = "Liming@waneta.com";
                ...
                studentInfo.userBaseInfo.email = "Demo@waneta.com";
                studentInfo.userBaseInfo.coachID = userInfo.userBaseInfo.email;
				studentInfo.bodyInfo.boydHeight = 323.9f;
        ...
        {
			string encryptFile = string.Format("{0}/{1}.ts", Application.dataPath+"/Example/u_utils/Example3_JsonData", fileName);
		...
		public UsersData ReadUsersData()
		{
			...
			//检查基本数据文件是否存在，并尝试解析
			string normalFile = string.Format("{0}/{1}.txt", Application.dataPath+"/Example/u_utils/Example3_JsonData", "userinfo");
			string encryptFile = string.Format("{0}/{1}.ts", Application.dataPath+"/Example/u_utils/Example3_JsonData", "userinfo");
			#if !CLIENT_WEB
				...
				case FileTaskStatus.Success:
					{
						
						{
							...
							if (vercode != ClientConfig.DataVersionCode)
							{
								...
								fname = string.Format("{0}/{1}.txt", Application.dataPath+"/Example/u_utils/Example3_JsonData", "userinfo");
								if (File.Exists(fname))
								{
									File.Delete(fname);
								}

								fname  = string.Format("{0}/{1}.ts", Application.dataPath+"/Example/u_utils/Example3_JsonData", "userinfo");
