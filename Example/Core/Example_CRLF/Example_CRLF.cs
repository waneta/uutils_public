...
namespace Client.UUtils.Example
{
    ...
    public class Example_CRLF : MonoBehaviour
    {
        ...
        void Start()
        {
            string crlf_file = "file:///"+ Application.dataPath + "/Example/u_utils/Example_CRLF/" + "persistens_CRLF.txt";
            //string lf_file = "file:///"+Application.dataPath + "/Example/u_utils/Example_CRLF/" + "persistens_LF.txt";
