...
namespace SampleFramework.UUtils.Editor
{
    public class CreateCopylistFile : ScriptableObject
    {
        ...
        public static void StartConfigProjectStreamFile()
        {
            ...
            GetFilePath(Application.streamingAssetsPath + "/mySwingPro/" + "blankdata", "*.*", ref persistentsList);
            GetFilePath(Application.streamingAssetsPath + "/mySwingPro/" + "hitdata", "*.*", ref persistentsList);
            GetFilePath(Application.streamingAssetsPath + "/Baseball/" + "BaseData", "*.*", ref persistentsList);
            GetFilePath(Application.streamingAssetsPath + "/Rowboat/" + "RowData", "*.*", ref persistentsList);
